...
export function Post(props) {
    ...
    return (      
        <div className='w-1/5 bg-green-300 p-5 m-2 border-black border' key={props.postMessage.key}>
            ...
            <br />
            <LikeButton messageKey = {props.postMessage.key} likes={props.postMessage.val.likes}  setMessages = {props.setMessages} messageIndex = {props.postIndex}/>
            {props.postMessage.val.likes} liked this
            <input
              type='text'
              id='Comment'
              placeholder='Comment?'
